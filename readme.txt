...
= What has changed between version 2.0 and 2.1? =

Not much. Just some improvements in efficiency - less CPU cycles are now taken up extracting the relevant data from your TTIW lists.

One other change of note - if you specify a list limit of 1, the `<li>` and `</li>` tags will be suppresed. This is useful if you wish to embed the latest "wish" in the middle of a sentence.

= What changes were in version 2.0? =

1. The filename of the XML file is now explicitly provided
2. You can display the price
3. An item will not be displayed if all the quantity you wanted have been purchased
4. If the remaining number of items to buy is greater than 1, the quantity will be displayed along with the item
5. The "More..." link to your total list is dynamically fetched from the XML
